...
| :--- | :--- | :--- | :--- |
| **Shakib Al Hasan** | `01711223344` | Verified Sender (৳100,000) | Send transfers, create splits, trigger concurrency lab |
| **Tanmoy Das** | `01811223344` | Verified Receiver (৳100,000) | Receive money, check notifications, settle split bills |
| **Sadia Afrin** | `01911223344` | Family Contact (৳100,000) | Settle money requests, check due-date badges |
| **Nusrat Jahan** | `01611223344` | Split Participant (৳100,000) | Bill split participant |
| **Ahsan Habib** | `01511223344` | Split Participant (৳100,000) | Bill split participant |
