  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-slate-800/80 bg-[#090d16]/85 backdrop-blur-2xl transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        {/* When NOT Authenticated: Navbar is 100% minimal with NO buttons, NO extra text */}
        {!isAuthenticated ? null : (
          /* When Authenticated: Clean App Navigation & User Wallet */
          <>
                    ...
                    >
                      ...
                      <div className="mt-2 pt-2 border-t border-slate-800 space-y-1">
                        ...
                        >
                          ...
                          <span>Reset balances to ৳100k</span>
                        </button>
                        ...
                        <button
                          ...
                          className="w-full py-2 px-2.5 rounded-xl text-xs text-rose-400 hover:bg-rose-500/10 transition-colors flex items-center justify-center gap-2 font-semibold"
                        >
      ...
      {/* Mobile Tab Bar (Only when Authenticated) */}
      {isAuthenticated && (
