...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  // Focused 4 Daily Core Money Tabs (Uncluttered)
  const coreNavItems = [
  ...
  return (
    <>
      <header className="sticky top-0 z-40 w-full border-b border-slate-800/80 bg-[#090d16]/90 backdrop-blur-2xl transition-colors">
                ...
                {coreNavItems.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative px-4 py-2 rounded-xl text-xs font-semibold transition-colors flex items-center gap-1.5 z-10 ${
                      ...
                      >
                        ...
                        <div className="px-3 py-1.5 border-t border-b border-slate-800 my-1">
                          ...
                          <p className="text-[11px] text-slate-500">
                            Test multi-user transactions instantly
                          </p>
                        </div>
        ...
        {/* Mobile Sub Tab Bar (Only when Authenticated) */}
        {isAuthenticated && (
          <div className="flex md:hidden border-t border-slate-800 bg-slate-950/95 px-2 py-1.5 justify-around overflow-x-auto">
            {coreNavItems.map((item) => {
              const Icon = item.icon;
              const isActive = activeTab === item.id;
              return (
